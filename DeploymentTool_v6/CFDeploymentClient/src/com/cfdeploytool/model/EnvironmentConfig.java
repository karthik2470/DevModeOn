...
public class EnvironmentConfig {
    ...
    private java.util.List<String> allowedServerIds = new java.util.ArrayList<>();
    ...
    public java.util.List<String> getAllowedServerIds() {
        if (allowedServerIds == null) {
            allowedServerIds = new java.util.ArrayList<>();
        }
        return allowedServerIds;
    }

    public void setAllowedServerIds(java.util.List<String> allowedServerIds) {
        this.allowedServerIds = allowedServerIds;
    }
    ...
    public EnvironmentConfig copy() {
        ...
        c.allowedServerIds = new java.util.ArrayList<>(getAllowedServerIds());

        java.util.List<Server> copiedServers = new java.util.ArrayList<>();
        for (Server s : getServers()) {
            Server sc = new Server(s.getName(), s.getHost(), s.getPort(), s.getDescription());
            sc.setId(s.getId());
            sc.setStatus(s.getStatus());
            sc.setServerTypes(s.getServerTypes());
            sc.setLastChecked(s.getLastChecked());
            copiedServers.add(sc);
        }
        c.setServers(copiedServers);
        return c;
    }
