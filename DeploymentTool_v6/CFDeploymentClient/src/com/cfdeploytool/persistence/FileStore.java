...
public class FileStore {
    ...
    public FileStore(Path baseDir) {
        this.dataDir = Paths.get("C:/CFDeploy/data");
    ...
    public void saveUsers(String json) throws IOException {
        writeJson(usersFile, json);
    }

    public String loadUsers() throws IOException {
