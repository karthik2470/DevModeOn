...
/**
 * Handles POST /api/version/increment — manually increments the 4T version file.
 */
public class VersionIncrementHandler implements HttpHandler {

    private final VersionService versionService;

    public VersionIncrementHandler(VersionService versionService) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            VersionResult result = versionService.incrementVersion(category);
