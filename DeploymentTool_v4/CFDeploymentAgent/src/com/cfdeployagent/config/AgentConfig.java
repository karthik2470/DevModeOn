...
public class AgentConfig {
    ...
    public static AgentConfig load() throws IOException {
        ...
        Map<DeploymentTier, Path> pluginDll = new EnumMap<>(DeploymentTier.class);
        pluginDll.put(DeploymentTier.T2, resolvePath(baseDir, props,
                "path.plugindll.t2", "D:\\Temp\\Siemens\\tcroot\\portal\\plugins"));
        pluginDll.put(DeploymentTier.T4, resolvePath(baseDir, props,
                "path.plugindll.t4", "D:\\Temp\\Siemens\\customsolutions\\dll"));
        paths.put(DeploymentCategory.PLUGIN_DLL, Map.copyOf(pluginDll));
