...
public class TaskManagementService {
    ...
    public TaskStatusResult queryStatus(Server server, String services, String programs, String runningProcesses) {
        try {
            ...
            body.append("\"runningProcesses\":").append(JsonUtil.quote(runningProcesses != null ? runningProcesses : ""));
            body.append("}");
